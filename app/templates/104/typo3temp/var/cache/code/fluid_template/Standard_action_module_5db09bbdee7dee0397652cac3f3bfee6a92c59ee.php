...
class Standard_action_module_5db09bbdee7dee0397652cac3f3bfee6a92c59ee extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array3['0'] = '!';
$array4 = array (
);$array3['1'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('moduleMenuCollapsed', $array4)]);
$array3['2'] = ' && ';
$array5 = array (
);$array3['3'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('hasModules', $array5)]);
...
$array21['0'] = '!';
$array22 = array (
);$array21['1'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('hasModules', $array22)]);
