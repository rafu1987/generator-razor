...
--
-- Tabellenstruktur für Tabelle `form_definition`
--
...
CREATE TABLE `sys_be_shortcuts` (
  ...
  `group_uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:guid)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `sys_be_shortcuts_group`
--
...
(1, 'installUpdate', 'TYPO3\\CMS\\Core\\Upgrades\\BackendUserLanguageMigration', 0x693a313b),
(2, 'installUpdate', 'TYPO3\\CMS\\Core\\Upgrades\\MigrateExtensionDataImportRegistryKeysUpdate', 0x693a313b),
(3, 'installUpdate', 'TYPO3\\CMS\\Core\\Upgrades\\PageDoktypeLinkMigration', 0x693a313b),
(4, 'installUpdate', 'TYPO3\\CMS\\Core\\Upgrades\\PagesRecyclerDoktypeMigration', 0x693a313b),
(5, 'installUpdate', 'TYPO3\\CMS\\Core\\Upgrades\\UserPermissionsForRenamedModulesMigration', 0x693a313b),
(6, 'installUpdate', 'TYPO3\\CMS\\Backend\\Upgrades\\UserSettingsMigration', 0x693a313b),
(7, 'installUpdate', 'TYPO3\\CMS\\Backend\\Upgrades\\UserSettingsNormalizationMigration', 0x693a313b),
(8, 'installUpdate', 'TYPO3\\CMS\\Backend\\Upgrades\\UserSettingsScrubbingMigration', 0x693a313b),
(9, 'installUpdate', 'TYPO3\\CMS\\Frontend\\Upgrades\\SynchronizeColPosAndCTypeWithDefaultLanguage', 0x693a313b),
...
ALTER TABLE `pages`
  ...
  ADD KEY `contentFromPid` (`content_from_pid`),
...
--
-- Indizes für die Tabelle `sys_be_shortcuts_group`
--
ALTER TABLE `sys_be_shortcuts_group`
  ADD PRIMARY KEY (`uuid`),
  ADD KEY `user_groups` (`userid`);
...
ALTER TABLE `tt_content`
  ...
  ADD KEY `language_identifier` (`l18n_parent`,`sys_language_uid`),
  ADD KEY `translation_source` (`l10n_source`),
  ADD KEY `t3ver_oid` (`t3ver_oid`,`t3ver_wsid`);
...
--
-- AUTO_INCREMENT für Tabelle `form_definition`
--
ALTER TABLE `form_definition`
  MODIFY `uid` int UNSIGNED NOT NULL AUTO_INCREMENT;
