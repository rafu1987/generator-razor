...
class partial_Donation_5c3bb7107f5346014c782c0a6ae5c05a9b55cbd1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['key'] = 'LLL:EXT:about/Resources/Private/Language/Modules/about.xlf:donation_header';
...
$arguments5['key'] = 'LLL:EXT:about/Resources/Private/Language/Modules/about.xlf:donation_message';
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('donationUrl', $array7)]);

$output0 .= '" class="btn btn-default" title="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$arguments8['key'] = 'LLL:EXT:about/Resources/Private/Language/Modules/about.xlf:donation_button';
...
$arguments10['key'] = 'LLL:EXT:about/Resources/Private/Language/Modules/about.xlf:donation_button';
