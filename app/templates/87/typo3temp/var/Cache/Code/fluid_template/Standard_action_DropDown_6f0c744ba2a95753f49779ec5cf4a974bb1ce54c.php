...
class Standard_action_DropDown_6f0c744ba2a95753f49779ec5cf4a974bb1ce54c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments13['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_misc.xlf:bookmark_description';
// Rendering Array
$array15 = array();
$output16 = '';
...
$arguments8['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:toolbarItems.bookmarks';
...
$arguments22['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:toolbarItems.bookmarks';

$output21 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments22, $renderChildrenClosure23, $renderingContext), ENT_QUOTES);
...
$expression79 = function($context) {return !(($context["node1"]));};
...
$output85 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.id', $array86), ENT_QUOTES);

$output85 .= '">';
$array87 = array (
);
$output85 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.title', $array87), ENT_QUOTES);
...
$output74 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.id', $array88), ENT_QUOTES);
...
$renderChildrenClosure59 = $arguments58['subject'] ? function() use ($arguments58) { return $arguments58['subject']; } : $renderChildrenClosure59;$array57['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments58, $renderChildrenClosure59, $renderingContext);
$array57['1'] = ' == 0';

$expression61 = function($context) {return (($context["node0"]) == 0);};
...
$expression38 = function($context) {return !(($context["node1"]));};
...
$output44 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.id', $array45), ENT_QUOTES);

$output44 .= '">';
$array46 = array (
);
$output44 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.title', $array46), ENT_QUOTES);
...
$output33 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('group.id', $array47), ENT_QUOTES);
...
$arguments113['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_misc.xlf:bookmark_description';
// Rendering Array
$array115 = array();
$output116 = '';
...
$arguments108['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:toolbarItems.bookmarks';
