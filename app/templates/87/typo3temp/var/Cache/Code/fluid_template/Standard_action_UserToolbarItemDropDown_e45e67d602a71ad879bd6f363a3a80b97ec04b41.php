...
class Standard_action_UserToolbarItemDropDown_e45e67d602a71ad879bd6f363a3a80b97ec04b41 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('module.link', $array36), ENT_QUOTES);

$output12 .= '" title="';
$array37 = array (
);
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('module.description', $array37), ENT_QUOTES);

$output12 .= '">
						';
$array38 = array (
);
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('module.title', $array38), ENT_QUOTES);
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('logoutUrl', $array39), ENT_QUOTES);
