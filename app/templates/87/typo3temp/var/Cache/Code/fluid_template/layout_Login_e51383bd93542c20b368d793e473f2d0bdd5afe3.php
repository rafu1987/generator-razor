...
class layout_Login_e51383bd93542c20b368d793e473f2d0bdd5afe3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('logo', $array1), ENT_QUOTES);
...
$arguments131['state'] = 2;
$renderChildrenClosure132 = $arguments131['message'] ? function() use ($arguments131) { return $arguments131['message']; } : $renderChildrenClosure132;
...
$arguments135['state'] = 2;
$renderChildrenClosure136 = $arguments135['message'] ? function() use ($arguments135) { return $arguments135['message']; } : $renderChildrenClosure136;
...
$output120 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('loginProviderIdentifier', $array139), ENT_QUOTES);
...
$arguments15['state'] = 2;
$renderChildrenClosure16 = $arguments15['message'] ? function() use ($arguments15) { return $arguments15['message']; } : $renderChildrenClosure16;
...
$arguments19['state'] = 2;
$renderChildrenClosure20 = $arguments19['message'] ? function() use ($arguments19) { return $arguments19['message']; } : $renderChildrenClosure20;
...
$output4 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('loginProviderIdentifier', $array23), ENT_QUOTES);
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('images.typo3', $array237), ENT_QUOTES);
