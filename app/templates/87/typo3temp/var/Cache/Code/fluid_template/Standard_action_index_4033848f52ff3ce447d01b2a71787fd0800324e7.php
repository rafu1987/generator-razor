...
class Standard_action_index_4033848f52ff3ce447d01b2a71787fd0800324e7 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output4 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('mainModule.title', $array34), ENT_QUOTES);
...
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.name', $array39), ENT_QUOTES);

$output38 .= '" class="modulemenu-item t3js-mainmodule" data-modulename="';
$array40 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('mainModule.name', $array40), ENT_QUOTES);

$output38 .= '" data-navigationcomponentid="';
$array41 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.navigationComponentId', $array41), ENT_QUOTES);

$output38 .= '" data-navigationframescript="';
$array42 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.navigationFrameScript', $array42), ENT_QUOTES);

$output38 .= '" data-navigationframescriptparameters="';
$array43 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.navigationFrameScriptParameters', $array43), ENT_QUOTES);

$output38 .= '">
						<a href="#" data-link="';
$array44 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.link', $array44), ENT_QUOTES);

$output38 .= '" class="modulemenu-item-link" title="';
$array45 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.description', $array45), ENT_QUOTES);
...
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.title', $array49), ENT_QUOTES);
