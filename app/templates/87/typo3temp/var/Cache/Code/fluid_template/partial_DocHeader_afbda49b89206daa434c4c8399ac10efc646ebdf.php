...
class partial_DocHeader_afbda49b89206daa434c4c8399ac10efc646ebdf extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure81 = $arguments80['subject'] ? function() use ($arguments80) { return $arguments80['subject']; } : $renderChildrenClosure81;$array79['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments80, $renderChildrenClosure81, $renderingContext);
$array79['1'] = ' > 1';

$expression83 = function($context) {return (($context["node0"]) > 1);};
...
$renderChildrenClosure26 = $arguments25['subject'] ? function() use ($arguments25) { return $arguments25['subject']; } : $renderChildrenClosure26;$array24['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments25, $renderChildrenClosure26, $renderingContext);
$array24['1'] = ' > 1';

$expression28 = function($context) {return (($context["node0"]) > 1);};
...
$output129 .= $renderingContext->getVariableProvider()->getByPath('docHeader.metaInformation.recordInformationUid', $array130);
...
// Rendering Array
$array127 = array();
$array127['0'] = 'docHeader.metaInformation.recordInformationUid}';

$expression128 = function($context) {return "docHeader.metaInformation.recordInformationUid}";};
...
$arguments131['partial'] = 'ButtonBar';
// Rendering Array
$array133 = array();
$array134 = array (
);$array133['buttons'] = $renderingContext->getVariableProvider()->getByPath('docHeader.buttons.left', $array134);
$arguments131['arguments'] = $array133;

$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments131, $renderChildrenClosure132, $renderingContext);
...
$arguments135['partial'] = 'ButtonBar';
// Rendering Array
$array137 = array();
$array138 = array (
);$array137['buttons'] = $renderingContext->getVariableProvider()->getByPath('docHeader.buttons.right', $array138);
$arguments135['arguments'] = $array137;

$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments135, $renderChildrenClosure136, $renderingContext);
